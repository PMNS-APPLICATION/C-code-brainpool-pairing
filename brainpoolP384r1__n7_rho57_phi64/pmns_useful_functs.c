...
void init_data(){
	...
	mpz_init (modul_p);
	mpz_set_str (modul_p, "21659270770119316173069236842332604979796116387017648600081618503821089934025961822236561982844534088440708417973331", 10);

	mpz_set_str (gama_pow[0], "11122730497867082426703774898586389214554972136239004234162613722782469803511232111483936084892743587563706779788925", 10);

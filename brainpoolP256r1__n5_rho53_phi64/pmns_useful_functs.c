...
void init_data(){
	...
	mpz_init (modul_p);
	mpz_set_str (modul_p, "76884956397045344220809746629001649093037950200943055203735601445031516197751", 10);

	mpz_set_str (gama_pow[0], "69419170576495936951229257827200835275135500751173168338114307761123131575941", 10);

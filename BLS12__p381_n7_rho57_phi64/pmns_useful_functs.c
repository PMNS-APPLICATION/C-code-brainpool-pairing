...
void init_data(){
	...
	mpz_init (modul_p);
	mpz_set_str (modul_p, "4002409555221667393417789825735904156556882819939007885332058136124031650490837864442687629129015664037894272559787", 10);

	mpz_set_str (gama_pow[0], "823127577348045540193235100785221417053475660617499060035235085625592808014367940275273216667542661581486816687030", 10);

...
void init_data(){
	...
	mpz_init (modul_p);
	mpz_set_str (modul_p, "8948962207650232551656602815159153422162609644098354511344597187200057010413552439917934304191956942765446530386427345937963894309923928536070534607816947", 10);

	mpz_set_str (gama_pow[0], "2067014062363224129210690211279144439563835637638913715295707397391403195241138859813388652958753613666934307936925689213749250855507845807571118090393337", 10);

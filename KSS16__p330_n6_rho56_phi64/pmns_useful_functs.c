...
void init_data(){
	...
	mpz_init (modul_p);
	mpz_set_str (modul_p, "1256028785022992686281976800775584186790077152694705296490733913907463653887495118497881818417348781", 10);

	mpz_set_str (gama_pow[0], "1164558366768138028254091418965201582854750615277822218812049611434501984916797877633157852749627507", 10);
